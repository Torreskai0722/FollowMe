...
echo_and_run cd "/home/nvidia/projects/rosproject/src/ros_controllers/rqt_joint_trajectory_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/projects/rosproject/src/ros_controllers/rqt_joint_trajectory_controller/setup.py" \
     \
    build --build-base "/home/nvidia/projects/rosproject/build/ros_controllers/rqt_joint_trajectory_controller" \
    install \
    --root="${DESTDIR-/}" \
