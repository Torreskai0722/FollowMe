...
(cl:defmethod cl:initialize-instance :after ((m <RandomNumber-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RandomNumber-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-srv:<RandomNumber-request> is deprecated: use robot-srv:RandomNumber-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <RandomNumber-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RandomNumber-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-srv:<RandomNumber-response> is deprecated: use robot-srv:RandomNumber-response instead.")))

(cl:ensure-generic-function 'random_number-val :lambda-list '(m))
(cl:defmethod random_number-val ((m <RandomNumber-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-srv:random_number-val is deprecated.  Use robot-srv:random_number instead.")
  (random_number m))
