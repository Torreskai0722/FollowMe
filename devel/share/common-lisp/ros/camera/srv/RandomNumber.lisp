...
(cl:defmethod cl:initialize-instance :after ((m <RandomNumber-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RandomNumber-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera-srv:<RandomNumber-request> is deprecated: use camera-srv:RandomNumber-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <RandomNumber-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RandomNumber-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera-srv:<RandomNumber-response> is deprecated: use camera-srv:RandomNumber-response instead.")))

(cl:ensure-generic-function 'random_number-val :lambda-list '(m))
(cl:defmethod random_number-val ((m <RandomNumber-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera-srv:random_number-val is deprecated.  Use camera-srv:random_number instead.")
  (random_number m))
