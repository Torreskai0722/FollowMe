...
(cl:defmethod cl:initialize-instance :after ((m <SentMessage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SentMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-msg:<SentMessage> is deprecated: use test-msg:SentMessage instead.")))

(cl:ensure-generic-function 'sender-val :lambda-list '(m))
(cl:defmethod sender-val ((m <SentMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:sender-val is deprecated.  Use test-msg:sender instead.")
  (sender m))

(cl:ensure-generic-function 'content-val :lambda-list '(m))
(cl:defmethod content-val ((m <SentMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:content-val is deprecated.  Use test-msg:content instead.")
  (content m))
