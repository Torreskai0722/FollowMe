...
(cl:defmethod cl:initialize-instance :after ((m <RandomNumber-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RandomNumber-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor-srv:<RandomNumber-request> is deprecated: use motor-srv:RandomNumber-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <RandomNumber-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RandomNumber-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor-srv:<RandomNumber-response> is deprecated: use motor-srv:RandomNumber-response instead.")))

(cl:ensure-generic-function 'random_number-val :lambda-list '(m))
(cl:defmethod random_number-val ((m <RandomNumber-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor-srv:random_number-val is deprecated.  Use motor-srv:random_number instead.")
  (random_number m))
