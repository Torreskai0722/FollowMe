...
(cl:defmethod cl:initialize-instance :after ((m <SentMessage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SentMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<SentMessage> is deprecated: use lidar-msg:SentMessage instead.")))

(cl:ensure-generic-function 'sender-val :lambda-list '(m))
(cl:defmethod sender-val ((m <SentMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:sender-val is deprecated.  Use lidar-msg:sender instead.")
  (sender m))
