...
if __name__ == "__main__":
    rospy.init_node("follower_motion_controller")

    drive_pub = rospy.Publisher("/follower/drive_command", Float32, queue_size=10)
    turn_pub = rospy.Publisher("/follower/turn_command", Float32, queue_size=10);
    ...
    quit_pub = rospy.Publisher("/follower/motion_handler/quit", Float32, queue_size=10)

    rospy.Subscriber("/follower/follower_pose", PoseStamped, onOdometryUpdate)
    rospy.Subscriber("/follower/motion_handler/status", Float32, onStatusUpdate)
    rospy.Subscriber("/follower/motion_handler/waypoints", String, onWaypointsUpdate)
